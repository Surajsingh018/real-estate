    ...
    <DashboardLayout>
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="bg-white border-b border-gray-200 ">
          <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row md:justify-between md:items-center">
            <div>
              ...
              <p className="text-gray-600 text-sm">View and manage all your financial transactions</p>
            </div>
            <button className="mt-3 md:mt-0 flex items-center space-x-2 bg-gradient-to-r from-purple-400 to-purple-600 text-white px-4 py-2 rounded-lg shadow-md hover:from-purple-500 hover:to-purple-700">
        ...
        <div className="container mx-auto px-4 py-6 flex-1">
          ...
          {/* Filters */}
          <div className="card p-6 mb-8 grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="relative">
              <MagnifyingGlassIcon className="absolute left-3 top-1/3 transform -translate-y-1/2 w-5 h-5 text-gray-400" />
              <input
                type="text"
              ...
              {filteredTransactions.map((transaction) => (
                <div key={transaction.id} className="p-4 space-y-2">
                  ...
                  <div className="flex justify-between text-sm text-gray-600">
                    <div className="flex items-center space-x-2">{getStatusIcon(transaction.status)}<span>{transaction.status}</span></div>
                    <div className="flex items-center space-x-1"><CalendarIcon className="w-4 h-4" /><span>{new Date(transaction.date).toLocaleDateString()}</span></div>
                  </div>
